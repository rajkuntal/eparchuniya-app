...
<script type="text/javascript"
	src="<c:url value='/resources/js/usergroup_controller.js' />"></script>
...
<script type="text/javascript" src="<c:url value='/resources/js/usermgmtcontroller.js' />"></script>
		...
		<div class="customBody">
			<div class="tab-content">
				...
				<div class="tab-pane" id="datatable">
					<jsp:include page="dataTableExample.jsp"></jsp:include>
				</div>
			</div>
		</div>
